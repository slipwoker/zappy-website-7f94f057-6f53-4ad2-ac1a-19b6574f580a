        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '7f94f057-6f53-4ad2-ac1a-19b6574f580a',
                name: fullName,
                email: email,
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "PBI101 uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
